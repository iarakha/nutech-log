...
<div class="container-fluid" style="padding-top: 20px">
    ...
    <div class="row page-titles justify-content-between">
        ...
        <div class="col-lg-1 header-right">
            <a href="{{route('add-jenis_masalah')}}" class="btn btn-success shadow btn-xs ">Tambah</a>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Jenis Masalah</h4>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('jenis_masalah-edit', $item->id) }}"
                                                class="btn btn-primary shadow btn-xs sharp me-1">
                                                <i class="fas fa-pencil-alt"></i></a>
                                            <a onclick="return confirm('Apakah Anda yakin?');"
                                                href="{{ route('jenis_masalah-delete', $item->id) }}"
